...
describe('SparkBarchartComponent', () => {
	 ...
	 */
	xdescribe('Positive bar chart should', async () => {
	...
	xdescribe('Negative bar chart should', async () => {
		beforeEach(async () => {
	...
	xdescribe('Tri bar chart should', async () => {
		beforeEach(async () => {
	...
	xdescribe('Dual bar chart should', async () => {
		beforeEach(async () => {
			component.barHeights = JSON.stringify([-4, 3, -7, -8, -1, 1, 3, -2, -5, 3, -5, 8]);

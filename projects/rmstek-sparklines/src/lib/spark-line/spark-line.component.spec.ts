...
describe('SparkLineComponent', async () => {
	 ...
	 */
	xdescribe('Simple line chart should', () => {
		beforeEach(async () => {
		});
		xit('succeed drawing with default parameters', async () => {
		...
		xit('fail drawing with non-default parameters', async () => {
	...
	xdescribe('Decorated line chart should', async () => {
		beforeEach(async () => {
	...
	xdescribe('Shadded line chart should', async () => {
		beforeEach(async(() => {
			component.decorationPoints = JSON.stringify([{index: 0, color: 'red'}, {index: 11, color: 'black'}]);
			component.shadeColor = `LightBlue`;
		}));
		xit('succeed drawing the with default parameters', async () => {
